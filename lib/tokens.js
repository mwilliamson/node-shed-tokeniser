...
module.exports = {
    ...
    newLine: function(value, source) {
        return new Token("newline", value, source);
    },
    ...
    comment: function(value, source) {
        return new Token("comment", value, source);
    },
    indent: function(value, source) {
        return new Token("indent", value, source);
    },
    dedent: function(source) {
        return new Token("dedent", null, source);
    }
};
